  ...
  return (
    <div className="main-container">
      ...
      <section className="about-me">
        <p className="am-p">Hi! My name is Arne, I am a 27 year old Computer Science student from Norway.</p>
      ...
      <section className="links">
        ...
        <div className="linkbox-container">
          <LinkBox 
            icon={<IoLogoGithub className="logo" aria-label="Github logo" size={96} />}
            text="Github"
            url="https://github.com/bjarneboi"
          />
          <LinkBox 
            icon={<MdMailOutline className="logo" aria-label="Email icon" size={96} />}
            text="Email"
            url="mailto:arneks@hotmail.com" 
          />
          <LinkBox 
            icon={<FaLinkedin className="logo" aria-label="LinkedIn logo" size={96} />}
            text="LinkedIn"
